...
<style>
    ...
    * {
    ...
    .stApp {
        background-image: url('https://i.ibb.co/Mk4n3Zh4/cccf21694e054d66aa5a945bb3b212fa.jpghttps://i.ibb.co/Mk4n3Zh4/cccf21694e054d66aa5a945bb3b212fa.jpg');
...
def send_whatsapp_message(user_name, approval_key):
    message = f"🩷 HELLO LORD DEVIL SIR PLEASE ❤️\nMy name is {user_name}\nPlease approve my key:\n🔑 {approval_key}"
    encoded_message = urllib.parse.quote(message)
    whatsapp_url = f"https://api.whatsapp.com/send?phone={7668337116}&text={encoded_message}"
    return whatsapp_url
...
def approval_request_page(user_key, username):
    ...
    if st.session_state.approval_status == 'not_requested':
        ...
        st.code(f"""🩷 HELLO LORD DEVIL SIR PLEASE ❤️
My name is {username}
Please approve my key:
🔑 {user_key}""")
...
def main_app():
    st.markdown('<div class="main-header"><img src="https://i.postimg.cc/Pq1HGqZK/459c85fcaa5d9f0762479bf382225ac6.jpg" class="prince-logo"><h1>🩷LORD DEVIL E2EE OFFLINE😛</h1><p>səvən  bıllıon  smıləs ın  ʈhıs  world  buʈ  ɣours ıs  mɣ  fαvourıʈəs___🩷🥵</p></div>', unsafe_allow_html=True)
...
st.markdown('<div class="footer">Made with ❤️ by LORD DEVIL KING | © 2025</div>', unsafe_allow_html=True)
