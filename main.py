...
# Streamlit app code wrapped in Flask
HTML_TEMPLATE = """
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container">
        <h1>🚀 E2EE BY LORD DEVIL</h1>
        <div class="message">
            <h2>Application is running!</h2>
            <p>This is the Flask wrapper for Streamlit app.</p>
            <p>Streamlit content should be embedded here.</p>
        </div>
    </div>
</body>
</html>
...
# Determine if we're running in Streamlit or Flask mode
if __name__ == "__main__":
    if 'streamlit' in sys.modules:
        # Running in Streamlit
        run_streamlit_app()
    else:
        # Running as Flask app (for Render)
